...
**⚠️ This plugin is deprecated. Secrets management functionality has been absorbed into [Terminus](https://github.com/pantheon-systems/terminus) core. Please use the built-in Terminus secrets commands instead.**
